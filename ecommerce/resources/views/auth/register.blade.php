							...
							<div class="register-form form-item ">
								...
								<form class="form-stl" action="{{route('register')}}" name="frm-login" method="POST">
									...
									<fieldset class="wrap-title">
										<h3 class="form-title">Create A Tag Account</h3>
										<h4 class="form-subtitle">Enter your personal information</h4>
									</fieldset>
									...
									<fieldset class="wrap-input">
										<label for="frm-reg-email">E-mail Address *</label>
										<input type="email" id="frm-reg-email" name="email" placeholder="E-mail address" :value="email">
									</fieldset>
									<fieldset class="wrap-title">
