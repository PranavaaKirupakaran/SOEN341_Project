	...
	<div class="container">
        ...
        <div class="row">
                    ...
                    <div class="product product-style-3 equal-elem ">
                        <div class="product-thumnail">
                            <a href="{{route('product.details',['slug'=>$item->model->slug])}}" title="{{$item->model->name}}">
                                <figure><img src="{{ asset('assets/images/products/') }}/{{$item->model->image}}" alt="Beige T-shirt"></figure>
                            </a>
                        </div>
                        <div class="product-info">
                            ...
                            <a  class="btn add-to-cart" wire:click.prevent="moveProductFromWishlistToCart('{{$item->rowId}}')" href="#">Move To Cart</a>
                        </div>
                    </div>
                </li>
                @endforeach
            ...
            <div class="text-center" style="padding: 30px 0;">
                ...
                <a href="/shop" class="btn btn-success">Add Product</a>
           </div>
            @endif
        </div>
    </div>
